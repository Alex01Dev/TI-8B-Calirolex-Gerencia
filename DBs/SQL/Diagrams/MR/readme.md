...
Este directorio contiene los diagramas del **Modelo Relacional (MR)**, que representan la base de datos en su forma lógica, traduciendo las entidades y relaciones en **tablas normalizadas** listas para su implementación en un **DBMS**.

El Modelo Relacional es la representación final antes de la implementación en una base de datos SQL. Se recomienda revisarlo cuidadosamente para garantizar la consistencia e integridad de los datos.   

## 📜 Contenido  

- Diagramas en formatos `.png`, `.jpg`, `.pdf`, `.drawio`.  
- Esquemas de tablas con claves primarias, foráneas y restricciones de integridad.  
