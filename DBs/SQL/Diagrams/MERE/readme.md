...
Este directorio almacena los diagramas del **Modelo Entidad-Relación Extendido (MERE)**, que amplían el modelo tradicional con conceptos avanzados como:  

- **Generalización y especialización**  
- **Herencia de entidades**  
- **Relaciones de múltiples niveles** 

El MERE se usa en escenarios donde es necesario modelar datos más complejos, permitiendo estructurar información con jerarquías y relaciones avanzadas.  

## 📜 Contenido  

- Diagramas en formatos `.png`, `.jpg`, `.pdf`, `.drawio`.  
- Explicaciones detalladas de las extensiones aplicadas en la modelación de datos.  
