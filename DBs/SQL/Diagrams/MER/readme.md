...
Este directorio contiene los diagramas de **Modelo Entidad-Relación (MER)** que representan la estructura conceptual de la base de datos SQL.
Se utilizan para visualizar entidades, atributos y relaciones, proporcionando una visión clara del modelo de datos antes de su implementación.  

## 📜 Contenido  

- Diagramas en formatos `.png`, `.jpg`, `.pdf`, `.drawio`.  
- Documentación explicativa de las entidades y relaciones clave.  
