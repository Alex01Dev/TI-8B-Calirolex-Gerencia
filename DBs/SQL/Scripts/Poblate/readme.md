...
![Database](https://img.shields.io/badge/DataPopulation-4E9A29?style=for-the-badge&logo=database&logoColor=white)

## 📁 Descripción  

Esta carpeta contiene los scripts SQL para poblar la base de datos con datos iniciales. Estos datos pueden ser registros de prueba o información esencial requerida para el correcto funcionamiento de la aplicación.

Los archivos incluyen sentencias **INSERT INTO**, **UPDATE**, y definiciones de valores por defecto para las tablas de la base de datos.
