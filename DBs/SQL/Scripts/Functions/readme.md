...
![Functions](https://img.shields.io/badge/Functions-4E9A29?style=for-the-badge&logo=database&logoColor=white)

## 📁 Descripción  

Esta carpeta contiene las funciones definidas en SQL que encapsulan lógica de negocio y cálculos dentro de la base de datos. Estas funciones permiten optimizar procesos al ejecutar operaciones directamente en el servidor de base de datos en lugar de en el código de aplicación.

Los archivos incluyen sentencias **CREATE FUNCTION**, definiciones de retorno y ejemplos de uso en consultas SQL.
