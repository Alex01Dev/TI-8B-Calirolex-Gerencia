...
Esta carpeta contiene los **scripts** utilizados en la base de datos **SQL** del área de **gerencia del gimnasio**. Su propósito es definir la estructura de la base de datos, poblarla con datos iniciales y establecer funciones o procedimientos almacenados que optimicen el rendimiento y la gestión de datos.

Los scripts permiten la creación eficiente de tablas, la inserción de datos de prueba y la implementación de funciones reutilizables. 

### 📌 **Subcarpetas**  

- **Creation/**: Contiene los scripts para la creación de tablas y estructuras de la base de datos.  
- **Functions/**: Incluye las funciones definidas para optimizar consultas y operaciones dentro de la base de datos.  
- **Poblate/**: Contiene scripts con datos de prueba o iniciales para poblar las tablas de la base de datos.  
- **USPS/**: Almacena procedimientos almacenados utilizados para automatizar tareas dentro del sistema.  

Cada carpeta incluye los scripts en formatos .sql
