...
![Database](https://img.shields.io/badge/Database-4E9A29?style=for-the-badge&logo=database&logoColor=white)

## 📁 Descripción  

Esta carpeta contiene los scripts SQL para la creación de la base de datos y sus estructuras fundamentales, como tablas, relaciones e índices. Es la base del sistema de gestión de datos y su correcto diseño garantiza integridad y eficiencia en las operaciones.

Los archivos incluyen sentencias **CREATE TABLE**, **ALTER TABLE**, **INDEX**, y otras definiciones estructurales necesarias para la base de datos.
