...
![Database](https://img.shields.io/badge/USPS-4E9A29?style=for-the-badge&logo=database&logoColor=white)

## 📁 Descripción  

Esta carpeta almacena procedimientos almacenados utilizados para automatizar tareas dentro del sistema.

Los archivos incluyen sentencias **INSERT INTO**, **SELECT**, y esquemas de tablas para manejar información relevante dentro del sistema.
## ✅ Tabla de Revisión  
