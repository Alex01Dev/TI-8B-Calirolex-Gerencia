...
Esta carpeta está destinada a almacenar los triggers utilizados en la base de datos SQL del área de de **gerencia del gimnasio**. Los triggers son procedimientos almacenados que se ejecutan automáticamente en respuesta a eventos específicos dentro de la base de datos, como inserciones, actualizaciones o eliminaciones de datos.

Estos triggers mejorarán la integridad y automatización de la base de datos.
