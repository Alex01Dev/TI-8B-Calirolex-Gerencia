...
##  📁 Descripción
La carpeta Full, dentro de Automated, almacena copias de seguridad completas y automatizadas de la base de datos NoSQL. Estas backups incluyen toda la estructura y los datos, permitiendo la restauración total del sistema en caso de fallos críticos.
...
- ✅ Se genera automáticamente según la programación definida.
- ✅ Ideal para migraciones, recuperación ante desastres y auditorías.
