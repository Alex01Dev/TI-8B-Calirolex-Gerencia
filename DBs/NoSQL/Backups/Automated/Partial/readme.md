...
## 📁 Descripción
La carpeta Partial, dentro de Automated, almacena copias de seguridad parciales de la base de datos NoSQL. Estas backups incluyen solo las colecciones o datos específicos seleccionados, optimizando el almacenamiento y los tiempos de restauración.

## 📌 Características
- ✅ Contiene copias de colecciones, documentos o índices específicos.
- ✅ Permite una restauración más rápida y enfocada en datos clave.
- ✅ Se genera automáticamente según la configuración establecida.
- ✅ Útil para respaldar datos críticos sin necesidad de un backup completo.
