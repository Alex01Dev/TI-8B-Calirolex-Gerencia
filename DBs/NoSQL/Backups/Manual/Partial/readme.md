...
## 📁 Descripción  
La carpeta **Partial** almacena copias de seguridad parciales de la base de datos NoSQL, creadas manualmente. Estas backups incluyen elementos específicos, como colecciones individuales, documentos críticos o configuraciones esenciales.  

### 📌 **Características**  

✅ Permite respaldar solo partes esenciales de la base de datos.  
✅ Útil para pruebas, migraciones o recuperación de información puntual.  
✅ Se crea manualmente según las necesidades del equipo.  
✅ Facilita una restauración rápida sin afectar toda la base de datos.  
...
🔄 **Recomendación:** Registrar qué datos se incluyeron en cada backup parcial para facilitar su restauración.  
