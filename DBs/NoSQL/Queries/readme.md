...
## 📌 Descripción
Esta carpeta contiene las consultas utilizadas en la base de datos NoSQL para el módulo de gerencia de un gimnasio. Las consultas permiten gestionar clientes, membresías, pagos y entrenadores de manera eficiente.
