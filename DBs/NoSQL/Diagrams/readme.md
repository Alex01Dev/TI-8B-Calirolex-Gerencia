...
## 📌 Descripción
Esta carpeta contiene los diagramas de la base de datos NoSQL que se implementará en MongoDB para la aplicación. Se incluyen representaciones visuales de la estructura de los documentos, relaciones entre colecciones y estrategias de indexación para mejorar el rendimiento.

## 📌 Contenido
- **Diagramas Entidad-Relación (ERD)**: Representación de los documentos y sus relaciones.
- **Modelado de Datos**: Definición de esquemas usando Mongoose.
- **Estrategias de Indexación**: Claves y consultas optimizadas para rendimiento.
- **Reglas de Normalización y Desnormalización**: Justificación del diseño.
