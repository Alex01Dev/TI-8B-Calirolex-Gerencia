...
## 📌 Descripción
En esta carpeta se encuentran los **scripts** utilizados para poblar la base de datos con datos iniciales o ficticios. Estos scripts facilitan la carga de información necesaria para probar y ejecutar correctamente el sistema en su fase de desarrollo.
