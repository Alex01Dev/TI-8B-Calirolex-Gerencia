...
Esta carpeta contiene los esquemas utilizados en la base de datos NoSQL para el módulo de gerencia de un gimnasio. Los esquemas definen la estructura de los documentos almacenados en MongoDB.

## 📌 Contenido
Los esquemas aquí definidos se encargan de modelar los datos principales del gimnasio, incluyendo:

- **Clientes**: Información personal y estado de actividad.
- **Membresías**: Tipo, fecha de inicio y vencimiento.
- **Pagos**: Registro de pagos realizados.
- **Coalboradores**: Datos sobre el personal quee trabaja en el gimnasio.
- **Horarios**: Disponibilidad de actividades.

Cada esquema está estructurado con un **ODM**, facilitando la integración con la base de datos MongoDB.
