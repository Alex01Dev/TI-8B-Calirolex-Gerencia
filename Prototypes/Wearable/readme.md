...
Esta carpeta contiene el código y documentación del desarrollo de la aplicación para dispositivos **Wear OS**, permitiendo a los usuarios acceder a funciones clave del sistema desde sus relojes inteligentes. La aplicación ha sido desarrollada en **Flutter** con soporte para integración en el ecosistema de Wearables.

### 📌 Funcionalidades principales  

1. **Monitoreo en tiempo real de la actividad física**
2. **Registro y seguimiento de entrenamientos**
3. **Notificaciones y recordatorios personalizados**
4. **Sincronización con la aplicación móvil principal**
5. **Visualización de estadísticas y progreso del usuario**

### 📌 **Subcarpetas**  

- **Assets**: Contiene imágenes, íconos y otros recursos gráficos.
- **Docs**: Documentación técnica sobre la arquitectura y desarrollo de la aplicación.
- **Lib**: Código fuente de la aplicación en **Flutter/Dart**.
