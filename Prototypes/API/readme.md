...
Esta carpeta contiene el código y la documentación relacionada con la API del proyecto. La API está construida utilizando **FastAPI** y **Python**, permitiendo una comunicación eficiente entre el frontend,backend y la base de datos.

Esta API permitirá al área de gerencia del gimnasio:

1. **Gestionar los datos de usuarios y suscripciones**
2. **Proveer endpoints para la generación de todas las operaciones solicitadas por el frontend**
3. **Autenticar y autorizar usuarios mediante JWT**
4. **Facilitar la integración con el frontend basado en Vue.js**

### 📌 **Subcarpetas**  

- **Routes**: Contiene las rutas y endpoints de la API.
- **Models**: Define los modelos de datos y esquemas utilizados.
- **Controllers**: Implementa la lógica de negocio y procesamiento de solicitudes.
- **Config**: Archivos de configuración para base de datos y entorno.
