...
![JavaScript](https://img.shields.io/badge/JavaScript-Scripts-yellow?style=for-the-badge&logo=javascript&logoColor=black)

## 📁 Descripción  

La carpeta **JS** contiene los archivos de **JavaScript** encargados de la interactividad y funcionalidad del **módulo de gerencia del gimnasio**.  

Aquí se encuentran los scripts que manejan la **lógica de negocio**, como la visualización dinámica de datos, integración con APIs, validación de formularios y generación de gráficos con bibliotecas como **Chart.js**.  

Estos archivos permiten que el sistema reaccione a las acciones del usuario y brinde una experiencia de navegación fluida y eficiente.  
