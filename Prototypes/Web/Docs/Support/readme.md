...
Esta carpeta contiene la documentación esencial para la correcta instalación y uso del sistema web de gestión del gimnasio. Incluye manuales detallados para ayudar a los administradores y usuarios a configurar y operar el sistema de manera eficiente.  
...
---  
📌 **Nota:** Para más información sobre cada documento, consulta su respectiva subcarpeta.
