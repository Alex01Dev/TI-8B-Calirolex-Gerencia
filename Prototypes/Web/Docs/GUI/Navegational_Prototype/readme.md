...
En esta carpeta se encuentra el **prototipo navegacional** del sistema web para el módulo de gerencia del gimnasio. Permite simular la navegación y el flujo de interacción entre pantallas.  
