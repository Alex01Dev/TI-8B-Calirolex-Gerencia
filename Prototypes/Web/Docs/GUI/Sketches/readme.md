...
![UI Design](https://img.shields.io/badge/UI-Sketches-green?style=for-the-badge)  

## 📁 Descripción  

Esta carpeta contiene los **bocetos iniciales** del diseño de la interfaz de usuario del módulo de gerencia del gimnasio. Representan ideas preliminares antes de los wireframes y mockups.  

## 📌 Contenido  

- Bocetos a mano o digitales de la interfaz  
- Conceptos exploratorios de diseño  
- Versiones alternativas de la GUI  

📌 **Nota:** Para ver los bocetos, consulta los archivos en esta carpeta.
