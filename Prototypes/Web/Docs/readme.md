...
Esta carpeta contiene la documentación relacionada con el desarrollo del prototipo web. Aquí se incluyen los requisitos, especificaciones y lineamientos necesarios para garantizar la correcta implementación del sistema.

### 📌 **Subcarpetas**  

- **BRs (Business Rules)**: Documenta las reglas de negocio que rigen el funcionamiento del sistema.
...
- **Support**: Documentación de soporte técnico y guías uso del software.
