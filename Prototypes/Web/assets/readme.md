...
![Assets](https://img.shields.io/badge/Assets-Images%20%26%20Icons-orange?style=for-the-badge)

## 📁 Descripción  

La carpeta **assets** contiene todos los recursos gráficos y multimedia utilizados en el **módulo de gerencia del gimnasio**. Aquí se almacenan imágenes, íconos, logos y otros elementos visuales que contribuyen a la identidad del sistema.  

Mantener un orden adecuado en esta carpeta es fundamental para una **carga eficiente de los recursos** y una mejor organización del proyecto.  
...
📌 **Nota:** Se recomienda comprimir imágenes para optimizar el rendimiento del sistema y evitar archivos innecesariamente pesados.
