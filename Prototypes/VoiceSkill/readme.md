...
Esta carpeta contiene el código y la documentación para la integración de un asistente de voz con **Google Assistant** y **Dialogflow**. Este módulo permitirá a los usuarios interactuar con el sistema a través de comandos de voz, ofreciendo una experiencia más accesible e intuitiva.

El asistente de voz permitirá:

1. **Consultar métricas y reportes de rendimiento en tiempo real**
2. **Gestionar horarios y disponibilidad de entrenadores y clases**
4. **Automatizar la comunicación interna con el personal**
5. **Acceder rápidamente a información de usuarios y membresías**



### 📌 **Subcarpetas**  

- **Agents**: Contiene los agentes de Dialogflow configurados para procesar comandos de voz.
- **Intents**: Definiciones de intenciones y respuestas del asistente.
- **Docs**: Documentación técnica sobre la configuración y desarrollo del módulo de voz.
- **Scripts**: Código necesario para la integración con otros sistemas del proyecto.
...
---  
📌 **Nota:** Para más información sobre la integración con el asistente de voz, consulta la documentación en la subcarpeta **Docs**.  
